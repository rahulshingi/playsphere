...
export default function About() {
  ...
  // Normalise legacy HTML <br> tags so they render as line breaks alongside whitespace-pre-line
  const normalise = (s) => (s || "").replace(/<\s*\/?\s*br\s*\/?\s*>/gi, "\n").replace(/\n{3,}/g, "\n\n").trim();
    ...
    <div className="bg-[#0a0a0a] min-h-screen text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-24">
        ...
        {a.company_description && (
          <p
            data-testid="about-company-description"
            className="text-neutral-300 mt-6 text-lg leading-relaxed whitespace-pre-line"
          >
            {normalise(a.company_description)}
          </p>
        )}
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-16">
          {a.mission && (
            <div className="border border-white/10 rounded-sm bg-[#141414] p-7">
              ...
              <p
                data-testid="about-mission-content"
                className="text-neutral-200 mt-3 leading-relaxed whitespace-pre-line"
              >
                {normalise(a.mission)}
              </p>
            </div>
          ...
          {a.vision && (
            <div className="border border-white/10 rounded-sm bg-[#141414] p-7">
              ...
              <p
                data-testid="about-vision-content"
                className="text-neutral-200 mt-3 leading-relaxed whitespace-pre-line"
              >
                {normalise(a.vision)}
              </p>
      ...
      {people.map((p, i) => (
        <div key={`${p.name || "person"}-${i}`} data-testid={`about-person-${i}`} className="border border-white/10 rounded-sm bg-[#141414] overflow-hidden">
          ...
          <div className="p-5">
            ...
            {p.bio && <p className="text-sm text-neutral-400 mt-3 leading-relaxed whitespace-pre-line">{p.bio}</p>}
