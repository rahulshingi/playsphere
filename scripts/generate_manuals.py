    ...
    role_blocks = {
        "vendor": [
            ...
            ("bul", [
                ...
                "<b>QR check-in</b> — scan or type booking-id or phone, checks in under 5 seconds. If the customer has multiple active contexts (a marketplace booking AND an active batch enrolment), the app now shows a picker so you can confirm which one they're here for. Every check-in shows in the <b>Currently on premises</b> panel with a countdown to slot-end — the row highlights red when the customer runs over. Tap <b>Check out</b> to close it; if they stayed past their slot the system auto-generates an <b>overrun invoice</b> for the extra hours at the same hourly rate. Print the reception QR poster (visible on the Check-in tab) so customers can self-scan to reach your listing page.",
                "<b>Coach & batch editor</b> — the Coaches &amp; batches tab now has a proper edit dialog (no more prompts). Every batch has a <b>Roster</b> button — enrol / unenrol customers from your directory, and get a red <b>FULL</b> badge + owner email the moment capacity fills up.",
                "<b>Customer directory CSV export</b> — the Customers tab has a big <b>Export CSV</b> button that downloads every customer with their visit count, total paid, and outstanding balance — ready for Excel / Google Sheets pivots.",
        ...
        "company": [
            ...
            ("bul", [
                ...
                "<b>Edit events after creation</b> — every event page now has an <b>Edit event</b> button (visible to platform admins + the event's organiser). Change name, description, venue or start/end date after the event is created; sport and format are locked to prevent breaking fixtures.",
                "<b>Book recurring slots in one go</b> — the booking modal on /hire has a <b>Book this weekly</b> toggle. Pick an end-date and the platform creates one booking per week automatically. Each occurrence lives as its own row in <b>My bookings</b>, so you can cancel or reschedule any single week without affecting the rest.",
